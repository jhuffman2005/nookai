      ...
      {step === "Result" && result && (
        <div style={S.cardWide}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 26 }}>
            <div><div style={S.label}>Before</div>{photo ? <a href={photo} target="_blank" rel="noopener noreferrer"><img src={photo} alt="before" style={{ width: "100%", height: 210, objectFit: "cover", borderRadius: 10, cursor: "zoom-in" }} /></a> : <div style={{ width: "100%", height: 210, borderRadius: 10, background: "#F0EDE8", display: "flex", alignItems: "center", justifyContent: "center" }}><span style={{ color: "#bbb", fontSize: 12, fontFamily: "sans-serif" }}>No photo</span></div>}</div>
            <div><div style={S.goldLabel}>✦ Your Vision</div>{genImage && !genImage.startsWith("ERROR:") ? <a href={genImage} target="_blank" rel="noopener noreferrer"><img src={genImage} alt="after" style={{ width: "100%", height: 210, objectFit: "cover", borderRadius: 10, cursor: "zoom-in" }} /></a> : <div style={{ width: "100%", height: 210, borderRadius: 10, background: "linear-gradient(135deg,#F0EDE8,#E8E2D8)", display: "flex", alignItems: "center", justifyContent: "center", border: "2px dashed #D4C9B8", padding: 12 }}><div style={{ textAlign: "center" }}><div style={{ fontSize: 28 }}>{selectedStyle && selectedStyle.emoji}</div><div style={{ fontSize: 11, fontFamily: "sans-serif", color: genImage && genImage.startsWith("ERROR:") ? "#E05555" : "#aaa", marginTop: 8, lineHeight: 1.5 }}>{genImage && genImage.startsWith("ERROR:") ? genImage.replace("ERROR:", "") : "✦ Rendering your vision..."}</div></div></div>}</div>
          </div>
      ...
      {step === "Result" && result && (
        <div style={S.cardWide}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 22 }}>
            <div><div style={S.label}>Before</div>{photo ? <a href={photo} target="_blank" rel="noopener noreferrer"><img src={photo} alt="before" style={{ width: "100%", height: 200, objectFit: "cover", borderRadius: 10, cursor: "zoom-in" }} /></a> : <div style={{ width: "100%", height: 200, borderRadius: 10, background: "#F0EDE8", display: "flex", alignItems: "center", justifyContent: "center" }}><span style={{ color: "#bbb", fontSize: 12, fontFamily: "sans-serif" }}>No photo</span></div>}</div>
            <div><div style={S.goldLabel}>✦ With Updates</div>{genImage && !genImage.startsWith("ERROR:") ? <a href={genImage} target="_blank" rel="noopener noreferrer"><img src={genImage} alt="after" style={{ width: "100%", height: 200, objectFit: "cover", borderRadius: 10, cursor: "zoom-in" }} /></a> : <div style={{ width: "100%", height: 200, borderRadius: 10, background: "linear-gradient(135deg,#F0EDE8,#E8E2D8)", display: "flex", alignItems: "center", justifyContent: "center", border: "2px dashed #D4C9B8", padding: 12 }}><div style={{ textAlign: "center" }}><div style={{ fontSize: 22 }}>{selectedEls[0] && selectedEls[0].emoji}</div><div style={{ fontSize: 11, fontFamily: "sans-serif", color: genImage && genImage.startsWith("ERROR:") ? "#E05555" : "#aaa", marginTop: 6, lineHeight: 1.4 }}>{genImage && genImage.startsWith("ERROR:") ? genImage.replace("ERROR:", "") : "✦ Rendering your vision..."}</div></div></div>}</div>
          </div>
